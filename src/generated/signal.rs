...
pub enum Schema3ProbeRefusal {
    ...
    SourceChanged,
    LegacyEngineOpenOrSchema,
    LegacyAgentRegistryRegistration,
    LegacyMessageLedgerRegistration,
    LegacyLedgerHeadRegistration,
    LegacyRecipientInboxRegistration,
    LegacyThreadIndexRegistration,
    LegacyDeliveryOutboxRegistration,
    LegacyAgentRegistryDecode,
    LegacyMessageLedgerDecode,
    LegacyLedgerHeadDecode,
    LegacyRecipientInboxDecode,
    LegacyThreadIndexDecode,
    LegacyDeliveryOutboxDecode,
    LegacyLedgerInvariant,
    LegacyReferenceInvariant,
    LegacyDecoderPanic,
    PrivateCleanup,
}
#[rustfmt::skip]
