...
#[rustfmt::skip]
impl std::fmt::Display for MessageRecipient {
...
#[rustfmt::skip]
impl PartialEq<&str> for MessageRecipient {
...
#[rustfmt::skip]
impl AsRef<str> for MessageSender {
    fn as_ref(&self) -> &str {
        self.payload().as_str()
    }
}
#[rustfmt::skip]
impl PartialEq<&str> for MessageSender {
    fn eq(&self, other: &&str) -> bool {
        self.payload() == other
    }
}
...
#[rustfmt::skip]
impl PartialEq<&str> for MessageBody {
    fn eq(&self, other: &&str) -> bool {
        self.payload() == other
    }
}
...
pub mod short_header {
    ...
    pub const OUTPUT_MESSAGE_REQUEST_UNIMPLEMENTED: u64 = 0x0103000000000000;
}
